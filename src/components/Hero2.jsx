  ...
  return (
    <section id="home" 
        ...
        <h1 className="flex-1 font-poppins font-semibold ss:text-[45px] text-[52px] text-white ss:leading-[70.8px] leading-[50px]">
               Consultoria {" "} <br></br>
                <span className="text-gradient ss:text-[45px]">Mão na massa</span>{" "}
              </h1>
        ...
        <h1 className="font-poppins font-semibold ss:text-[45px] text-[52px] text-white ss:leading-[70.8px] leading-[50px] w-full">
        Desde a análise à implementação.
        </h1>
